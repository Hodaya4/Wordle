...
const blacklist = ["ControlLeft", "AltLeft", "ShiftLeft", "CapsLock", "Tab", "Backquote",
    "Digit1", "Digit2", "Digit3", "Digit4", "Digit5", "Digit6", "Digit7", "Digit8", "Digit9", "Digit0",
    "Minus", "Equal", "ControlRight", "AltRight",
...
function checkAnswer() {
    ...
    for (i = col; i > 0; i--) {
        ...
        if (letter == currentWord[col - i]) {
            ...
            document.getElementById(`r${currentRow}c${i}`).style.backgroundColor =
                "#3a3a3c";
            if(document.getElementById(letterToEnglish).style.backgroundColor != "#b59f3b" &&
                document.getElementById(letterToEnglish).style.backgroundColor != "#538d4e") {
